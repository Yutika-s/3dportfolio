...
const ProjectCard = ({index, name, description, tags, image, source_code_link}) =>{
  ...
  return(
    ...
    <div className='relative w-full h-[230px]'>
      ...
      <div className='absolute inset-0 flex justify-endm-3 card-img_hover'>
        <div
        onClick={()=> window.open
    ...
    <motion.div variants={textVariant()}>
      ...
      <div className='w-full flex'>
        ...
        variants={
          ...
          The following projects show my skills in various technologies and frameworks through real world examples.
